...
\begin{resB}{Coalgebraic Bisimulation is MDP bisimulation}
    ...
    \[\begin{tikzcd}[ampersand replacement=\&]
        ...
        \end{tikzcd}\]
    Such that the induced relation on $X^2$ is an equivalence relation. Then the induced relation is a traditional MDP bisimulation.

    As notation, let $B_I$ be the induced relation on $X^2$ from $B$, namely $\{\phi_X(b)\}$
    \dline
    \begin{proof}
